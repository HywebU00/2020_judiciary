$(function() {
    ...
    $('table').each(function(index, el) {
        //判斷沒有table_list
        if ($(this).parents('.table_list').length == 0 && $(this).parents('.fix_th_table').length == 0 && $(this).parent('form').length == 0 && $(this).parent('.table_sprite').length == 0 && $(this).parent('.table_thleft').length == 0) {
            $(this).scroltable();
        }
    });
